...
<div id="post-<?php the_ID(); ?>" <?php post_class('entry ' . $kale_post_class); ?>>
    ...
    <div class="entry-content">
        ...
        <div class="entry-readmore">
          <a class="btn btn-default" href="<?php the_permalink(); ?>">Les mer</a>
        </div>
        <?php } ?>
        ...
        <div class="entry-meta">
            ...
            if($kale_blog_feed_author_show == 1)    $kale_temp[] = '<div class="entry-author">' . __('av ', 'kale')
            ...
            if ( ! post_password_required() && comments_open() && $kale_blog_feed_comments_show == 1)
                                                    $kale_temp[] = '<div class="entry-comments"><a href="'.esc_url(get_comments_link()).'">'. sprintf( _nx( '%1$s kommentar', '%1$s kommentarer', get_comments_number(), 'comments title', 'kale' ), number_format_i18n( get_comments_number() ) ) .'</a></div>';
            $kale_str = '';
